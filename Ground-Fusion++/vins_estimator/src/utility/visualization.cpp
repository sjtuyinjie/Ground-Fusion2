...
void registerPub(ros::NodeHandle &n)
{
    ...
    pub_latest_odometry_ros = n.advertise<nav_msgs::Odometry>("/vins/odometry/imu_propagate_ros", 1000);
...
void pubLatestOdometry(const Eigen::Vector3d &P, const Eigen::Quaterniond &Q, const Eigen::Vector3d &V, double t)
{
    ...
    {
        // ROS_WARN("pubLatestOdometry: NaN detected in position, orientation or velocity.");
        return;
    }

    if (Q.x() * Q.x() + Q.y() * Q.y() + Q.z() * Q.z() + Q.w() * Q.w() < 0.99)
    {
        // cout << "Q较小" << endl; todo 归一化
