...
int Voxel_mapping::service_LiDAR_update()
{
    ...
    // 用于给voxelmap创建pose话题的发布者
    ros::Publisher pub_pose = m_ros_node_ptr->advertise< geometry_msgs::PoseStamped >( "/pose_estimate", 100 );
...
// filter_size_map_min);
    ...
    std::cout << "m_extrin_T1: ";
    for (const auto& val : m_extrin_T) {
        std::cout << val << " ";
    }
    std::cout << std::endl;

    std::cout << "m_extrin_R1: ";
    ...
    std::cout << "m_extrin_T2: ";
    for (const auto& val : m_extrin_T) {
        std::cout << val << " ";
    }
    std::cout << std::endl;

    std::cout << "m_extrin_R2: ";
    for (const auto& val : m_extrin_R) {
        std::cout << val << " ";
    }
    std::cout << std::endl;

    std::cout << "m_extT: " << std::endl << m_extT << std::endl;
    std::cout << "m_extR: " << std::endl << m_extR << std::endl;
